...
_G.GridStatusRaidDebuff:DebuffId(zoneid, 106934, 21, 6, 6, true)
_G.GridStatusRaidDebuff:DebuffId(zoneid, 107047, 22, 6, 6, true)
_G.GridStatusRaidDebuff:DebuffId(zoneid, 116297, 23, 6, 6, true)
...
_G.GridStatusRaidDebuff:DebuffId(zoneid, 111600, 42, 6, 6, true)
_G.GridStatusRaidDebuff:DebuffId(zoneid, 111723, 43, 6, 6, true)
_G.GridStatusRaidDebuff:DebuffId(zoneid, 111725, 44, 6, 6, true)